...
import { ArrowRight, Info, Database, Layers, Hexagon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="reveal text-lg text-white/80 max-w-2xl mx-auto">
            Key information about the USDN token and its specifications.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {tokenData.map((item, index) => (
            ...
            >
              ...
              {item.subtext && (
                <div className="text-sm text-white/60 mt-1">{item.subtext}</div>
              )}
            </div>
          ))}
        </div>
